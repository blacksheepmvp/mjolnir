# 📄 **Mjolnir v0.2.5c Specification – Advanced Dual Screenshot (Root/Shizuku)**
...
**UX Philosophy:** "Invisible Feature" — The feature exists only if the user has set up the environment (Root or Shizuku). No in-app onboarding UI.
